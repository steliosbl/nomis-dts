...
class NomisApiConnector:
    ...
    def dataset_exists(self, id: str) -> bool:
        ...
        # Will except if there is an issue with the request or the response is unexpected.
            ...
            #print(res)
            print("ERROR: Unexpected response or invalid request whilst attempting to clarify a dataset's existence.")
        return False
    ...
    def create_dataset(self, id: str, ds: dict) -> bool:
        ...
        try:
            ...
            elif res.status_code == 404: print("ERROR: Dataset already exists.")
            else: raise
    ...
    def variable_exists(self, name: str) -> bool:
        try:
            ...
            return res.ok
        except: print("ERROR: Unexpected response or invalid request whilst attempting to clarify a variable's existence.")
        return False
